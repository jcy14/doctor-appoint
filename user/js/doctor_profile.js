// Doctor Profile JavaScript Functions
...
document.getElementById('profile-picture-input')?.addEventListener('change', function(e) {
    ...
    if (file) {
        ...
        fetch('../php/update_doctor_profile.php', {
            method: 'POST',
            body: formData
        })
...
function saveProfile() {
    ...
    // Show loading state
    // Find the Save Changes button in the modal footer
    const saveButton = document.querySelector('#edit-profile-modal .modal-footer .btn-primary');
    ...
    .catch(error => {
        console.error('Error:', error);
        alert(error.message || 'Failed to update the profile');
    })
    .finally(() => {
        // Reset button state
        if (saveButton) {
