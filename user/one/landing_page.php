...
try {
    ...
    // Get patient data for header if logged in
    $patient = null;
...
<body>
    ...
    <div class="find-doctors">
        <div class="page-header">
            <h1>Find The Right Doctor Or Dentist For You </h1>
            <p>Search from our network of qualified healthcare professionals in Davao City</p>
        </div>
    ...
    <script src="../js/find_doctors.js"></script>
     <script>
        // Animation on scroll
